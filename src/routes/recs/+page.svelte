<div class="p-8 max-w-prose mx-auto space-y-8 flex-row">
    <div class="p-8 max-w-prose mx-auto space-y-8 flex-row">
        <p class="dark:text-white text-black">books</p>
        <li>
            <a class="dark:text-white text-black hover:underline" href="https://en.wikipedia.org/wiki/Scythe_(novel)" target="_blank">scythe by neal shusterman</a>
        </li>
        <li>
